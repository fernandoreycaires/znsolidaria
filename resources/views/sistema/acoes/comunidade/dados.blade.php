            ...
            <div class="x_content">
              <div class="col-md-3 col-sm-3  profile_left">
                ...
                <ul class="list-unstyled user_data">
                  ...
                  <li>
                    <i class="fa fa-briefcase user-profile-icon"></i> Contato da comunidade
                  </li>

                  <li class="m-top-xs">
                    <i class="fa fa-phone user-profile-icon"></i> +55 (11) 9 9676-6145
                  </li>
                ...
                <a href="#" class="btn btn-sm btn-success"><i class="fa fa-edit m-right-xs"></i> Editar Dados </a>
                <br>
