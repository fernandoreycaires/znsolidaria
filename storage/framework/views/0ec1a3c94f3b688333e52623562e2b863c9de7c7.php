...
<html lang="pt-br">
  <head>
    ...
    <!-- Font Awesome -->
    <link href="<?php echo e(asset('theme_lib/vendors/font-awesome/css/font-awesome.min.css')); ?>" rel="stylesheet">
    <!-- Bootstrap core CSS -->
    <link href="<?php echo e(asset('site/style.css')); ?>" rel="stylesheet"> 
        ...
        <link href="<?php echo e(asset('site/carousel.css')); ?> " rel="stylesheet">
      </head>
      <body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
              <li class="nav-item">
                <a class="nav-link"  href="https://www.instagram.com/zn_solidaria/" target="_blank"><img src="<?php echo e(asset('image/instagram.png')); ?>" width="25px" height="25px" alt="Instagram"></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://www.facebook.com/znsolidaria" target="_blank"><img src="<?php echo e(asset('image/facebook.png')); ?>" width="25px" height="25px" alt="Facebook"></a>
              </li>
            </ul>
            <div class="d-flex">
              <?php if(Route::has('login')): ?>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-outline-success">Sistema</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-success">Entrar</a>
                <?php endif; ?>
              <?php endif; ?>
            </div>
          </div>
      ...
      <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="<?php echo e(asset('image/fotos/banner.svg')); ?>" class="bd-placeholder-img" width="100%" height="100%"  aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"> 
          ...
          <div class="carousel-item">
            <!-- <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#91466b"/></svg>-->
            <img src="<?php echo e(asset('image/fotos/banner2.svg')); ?>" class="bd-placeholder-img" width="100%" height="100%"  aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false">
          ...
          <div class="carousel-item">
            <!-- <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#91466b"/></svg> -->
            <img src="<?php echo e(asset('image/fotos/banner3.svg')); ?>" class="bd-placeholder-img" width="100%" height="100%"  aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false">
      ...
      <div class="container marketing">
        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <img src="<?php echo e(asset('image/foto_perfis/alina.jpg')); ?>" class="bd-placeholder-img rounded-circle" width="140" height="140" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"  >
          ...
          <div class="col-lg-4">
            <!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#e7afcb"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> -->
            <img src="<?php echo e(asset('image/foto_perfis/natalia.jpg')); ?>" class="bd-placeholder-img rounded-circle" width="140" height="140" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"  >
          ...
          <div class="col-lg-4">
            <!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#e7afcb"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> -->
            <img src="<?php echo e(asset('image/foto_perfis/fernando.jpg')); ?>" class="bd-placeholder-img rounded-circle" width="140" height="140" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"  >
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
            ...
            <img src="<?php echo e(asset('image/fotos/painel1.jpg')); ?>" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"  >
    ...
    -->
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#e7afcb"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> -->
            <img src="<?php echo e(asset('image/alimentos.jpeg')); ?>" class="bd-placeholder-img rounded-circle" width="140" height="140" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"  >
          ...
          <div class="col-lg-4">
            <!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#e7afcb"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> -->
            <img src="<?php echo e(asset('image/roupas.jpeg')); ?>" class="bd-placeholder-img rounded-circle" width="140" height="140" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"  >
          ...
          <div class="col-lg-4">
            <!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#e7afcb"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> -->
            <img src="<?php echo e(asset('image/dinheiro.jpeg')); ?>" class="bd-placeholder-img rounded-circle" width="140" height="140" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"  >
...
<?php /**PATH /var/www/html/znsolidaria/resources/views/welcome.blade.php ENDPATH**/ ?>