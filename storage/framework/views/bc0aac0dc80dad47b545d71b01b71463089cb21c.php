...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
      ...
      <ul class="nav side-menu">
        <li><a href="<?php echo e(route('dashboard')); ?>"><i class="fa fa-home"></i> Home </a>
      ...
      <ul class="nav side-menu">
        <li><a><i class="fa fa-thumb-tack"></i> Ações <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            ...
            <li><a href="<?php echo e(route('acoes.comunidade.index')); ?> ">Comunidade</a></li>
      ...
      <ul class="nav side-menu">
        <li><a><i class="fa fa-bitcoin"></i> Financeiro <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            <li><a href="<?php echo e(route('financeiro.dashboard')); ?> ">Dashboard Financeiro</a></li>
            <li><a href="<?php echo e(route('financeiro.caixa.index')); ?> ">Livro Caixa</a></li>
          </ul>
        </li>
      </ul>
    </div>
  ...
  <!-- /sidebar menu --><?php /**PATH /var/www/html/znsolidaria/resources/views/sistema/layout/menu_lateral.blade.php ENDPATH**/ ?>